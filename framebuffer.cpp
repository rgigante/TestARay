...
//	std::cout << "_minZDepth: " << _minZDepth << ", _maxZDepth: " << _maxZDepth << ", normalizingZDepth: " << normalizingZDepth << "\n";
...
//					std::cout << i <<"/"<< j << ", _depth[j][i]: " << _depth[j][i] << ", normalizedZVal: " << normalizedZVal << "\n" ;

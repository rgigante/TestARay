...
#ifdef NEW_HITABLE
bool HitableInstance::Hit2(const Ray& r, float t_min, float t_max, HitRecord& rec, Matrix* gm, bool debugRay /*= false*/)
{
	Ray ray(r);
...
//		"\t\t\t- oldray:"<< r << "\n"<<
//		"\t\t\t- newray:"<< ray <<"\n";
	bool hit = _obj->Hit2(ray, t_min, t_max, rec, nullptr, debugRay);
